...
public class PictureA extends JPanel {
	...
	public String printImage(JPanel panel,Integer atimes) {
		CompareA comparea = new CompareA();
		String imagepath = new File("").getAbsolutePath()+ "\\print\\" +atimes+"\\"+ "评论分类.jpg";
